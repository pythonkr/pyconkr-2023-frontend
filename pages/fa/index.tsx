...
const KoreanContent = (
  <H1Container>
    ...
    <H2Container>
      <H2>재정 지원 기준</H2>
      <H2P>
        재정 지원 프로그램은 파이콘 한국 참가에 대한 재정적인 장벽을 최소화하고
        파이썬 커뮤니티가 얻을 수 있는 장점을 최대화하기 위해 운영됩니다. 예를
        들어, 학생과 직장인 중에 선택해야 한다면 재정 지원은 학생에게 돌아갈
        가능성이 높습니다. 재정적인 문제로 파이콘에 참석하기 힘든 파이썬
        오픈소스 커미터 혹은 발표자의 경우에도 조금 더 높은 우선 순위로 고려하게
        됩니다.
      </H2P>
    </H2Container>
    <H2Container>
      ...
      <H2P>
        ...
        증빙할 수 있는 지출이어야 합니다. 지출과 신분 증빙은 세무 처리를 위하여
        필요합니다.
      </H2P>
      <H2P>
    ...
    <H2Container>
      ...
      <H2P>
        ...
        <br />* 당일에 지출 증빙을 위한 영수증, 사진이 있는 신분증(또는 학생증),
        기타 필요하다고 생각되는 자료를 파이콘 한국 2023 행사장에서 제출해주셔야
        합니다. 증빙이 없을 경우 지원이 불가능합니다.
      </H2P>
    </H2Container>
  </H1Container>
);
  ...
  <H1Container>
    ...
    <H2Container>
      ...
      <H2P>
        ...
        [Financial Aid] program to help those who are unable to attend the PyCon
        Korea for financial reasons. In addition to the budget prepared by the
        Organizing Team, we fund all sales from Patron tickets.
      </H2P>
    </H2Container>
    <H2Container>
      <H2>Principles and Targets</H2>
      <H2P>
        Financial aid program is designed to minimize the financial barriers to
        participation in PyCon Korea and maximize the benefits of the Python
        community. For example, if we have to choose between a student and an
        employee, financial support is likely to be given to the student. Python
        open source committers or speakers who are not able to attend PyCon
        Korea due to financial problems will also be considered as a higher
        priority.
      </H2P>
    </H2Container>
    <H2Container>
